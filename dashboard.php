											...
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
														...
														<span class="fw-light">Tugas</span>
													</h5>
                                     ...
                                     <!-- TAB NYA-->
                                            ...
                                            <div class="tab-content" id="pills-tabContent"> 
                                                ...
                                                <div class="tab-pane fade" id="pills-selesai" role="tabpanel" aria-labelledby="pills-selesai-tab">
                                                    <h1 class="text-center mt-4">DAFTAR KEGIATAN KOMPENSASI SELESAI</h1>
                                                ...
                                                <div class="tab-pane fade show active" id="pills-belum-selesai" role="tabpanel" aria-labelledby="pills-belum-selesai-tab">
                                                    <h1 class="text-center mt-4">DAFTAR KEGIATAN KOMPENSASI BELUM SELESAI</h1>
                                                    <table class="table table-bordered mt-3">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($data = mysqli_fetch_assoc($query)) : ?>
                                                                <tr>
                                                                    <td><?php echo $i++; ?></td>
                                                                    <td><?php echo $data['nama_tugas']; ?></td>
                                                                    <td class="text-center"><span class="badge bg-danger text-light"><?php echo $data['lokasi']; ?></span></td>
                                                                    <td class="text-center"><?php echo $data['jumlah_jam']; ?></td>
                                                                    <td><?php echo $data['tanggal']; ?></td>
                                                                    <td class="text-center"><span class=" btn-success btn-sm"><?php echo $data['mahasiswa_dibutuhkan']; ?></span></td>
                                                                    <td class="text-center">
                                                                        <a href="selesai.php?id=<?php echo $data['id']; ?>" class="btn btn-success btn-sm">Daftar</a>
                                                                    </td>
                                                                </tr>
                                                            <?php endwhile; ?>
                                                        </tbody>
